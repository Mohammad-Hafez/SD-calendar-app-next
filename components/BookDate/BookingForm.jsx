...
const BookingForm = ({
    ...
    const inputErrStyle = 'border-red-500 hover:border-red-500 focus:border-red-500 focus:ring-red-200 focus:shadow-sm focus:shadow-red-200 shadow shadow-red-200 text-red-600';
    const inputStyle = 'border-gray-300 focus:border-blue-500 focus:ring-blue-200 text-blue-900';
